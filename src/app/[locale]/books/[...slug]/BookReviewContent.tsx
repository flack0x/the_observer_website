          ...
          >
            ...
            <div className="relative">
              <div className="sticky top-24">
                <div className="relative aspect-[3/4] w-full max-w-[300px] mx-auto rounded-xl overflow-hidden border border-midnight-700 bg-midnight-800 shadow-xl">
                ...
                {/* Recommendation Badge - Below cover on mobile */}
                {badge && (
            ...
            <div>
              ...
              <motion.h1
                ...
                className="font-heading text-3xl sm:text-4xl font-bold text-slate-light mb-4 leading-tight"
              >
                {review.bookTitle}
              </motion.h1>
