...
const dictionaries = {
  en: {
    ...
    situationPreview: {
      ...
      description: 'Go beyond the headlines. Access sentiment analysis, trending topics, and key organization tracking to understand the patterns behind global events.',
      ...
      active: 'ACTIVE',
      liveFeed: 'LIVE FEED',
      sentimentAnalysis: 'Content Sentiment',
    ...
    books: {
      title: 'Book Reviews',
      subtitle: 'Curated intelligence reading list',
      rating: 'Rating',
      author: 'By',
      ...
      optional: 'Optional',
      noBooks: 'No book reviews found',
      loadMore: 'Load More Books',
      remaining: 'remaining',
      backToBooks: 'Back to Library',
      aboutBook: 'About This Book',
      telegramLink: 'View on Telegram',
    },
    // Voices page
    voices: {
      title: 'Voices',
      subtitle: 'Expert analysis from independent thinkers',
      featuredVoices: 'Featured Voices',
      featuredVoicesSubtitle: 'Independent analysts and authors challenging mainstream narratives',
  ...
  ar: {
    ...
    situationPreview: {
      ...
      description: 'تجاوز العناوين. احصل على تحليل المشاعر، والمواضيع الرائجة، وتتبع المنظمات الرئيسية لفهم الأنماط وراء الأحداث العالمية.',
      ...
      active: 'نشط',
      liveFeed: 'بث مباشر',
      sentimentAnalysis: 'تحليل المحتوى',
      analyticsPreview: 'معاينة التحليلات',
      trendingTopics: 'المواضيع الرائجة',
      keyOrganizations: 'المنظمات الرئيسية',
      mentions: 'إشارة',
    },
    // Footer
    footer: {
    ...
    books: {
      title: 'مراجعات الكتب',
      subtitle: 'قائمة قراءة استخباراتية منتقاة',
      rating: 'التقييم',
      author: 'المؤلف',
      ...
      recommended: 'موصى به',
      optional: 'اختياري',
      noBooks: 'لا توجد مراجعات كتب',
      loadMore: 'تحميل المزيد',
      remaining: 'متبقي',
      backToBooks: 'العودة إلى المكتبة',
      aboutBook: 'عن هذا الكتاب',
      telegramLink: 'عرض على تيليجرام',
    },
    // Voices page
    voices: {
      title: 'أصوات',
      subtitle: 'تحليلات الخبراء من مفكرين مستقلين',
      featuredVoices: 'أصوات مميزة',
      featuredVoicesSubtitle: 'محللون ومؤلفون مستقلون يتحدون الروايات السائدة',
      ...
      website: 'الموقع',
      amazon: 'أمازون',
      backToVoices: 'العودة إلى الأصوات',
      noVoices: 'لا توجد أصوات',
      exploreWritings: 'استكشف الكتابات',
    },
    // Comments section
    comments: {
      title: 'التعليقات',
      ...
      save: 'حفظ',
      edited: 'معدّل',
      loginToComment: 'سجّل الدخول للمشاركة في النقاش',
