        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          ...
          >
            <div className="mb-6 flex items-center gap-4">
              <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-tactical-red/10">
                <BarChart3 className="h-5 w-5 text-tactical-red" />
              </div>
              <div>
                <h2 className="font-heading text-2xl font-bold uppercase tracking-wider text-slate-light">
                  The Pulse
                </h2>
                <p className="text-sm text-slate-dark">Community intelligence polling</p>
              </div>
            </div>
            ...
            <div className="mb-8 grid grid-cols-2 gap-4">
              <div className="rounded-lg border border-midnight-600 bg-midnight-800 p-4">
                <div className="flex items-center gap-2">
                  <Users className="h-4 w-4 text-tactical-amber" />
                  <span className="font-heading text-2xl font-bold text-slate-light">
                    {activePoll.totalVotes.toLocaleString()}
                  </span>
                </div>
                <span className="text-xs text-slate-dark">Active Participants</span>
              </div>
              <div className="rounded-lg border border-midnight-600 bg-midnight-800 p-4">
                <div className="flex items-center gap-2">
                  <Vote className="h-4 w-4 text-earth-olive" />
                  <span className="font-heading text-2xl font-bold text-slate-light">
                    {activePoll.endsIn}
                  </span>
                </div>
                <span className="text-xs text-slate-dark">Until Poll Closes</span>
              </div>
            </div>

            <Link
              href="/polls"
              className="group inline-flex items-center gap-2 font-heading text-sm font-medium uppercase tracking-wider text-tactical-red transition-colors hover:text-tactical-amber"
            >
              View All Polls
          ...
          >
            <div className="mb-6">
              ...
              <h3 className="font-heading text-lg font-bold uppercase leading-snug tracking-wider text-slate-light">
                {activePoll.question}
              </h3>
            </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative flex items-center justify-between">
                      ...
                      {hasVoted && (
                        <span className="font-mono text-sm font-bold text-tactical-red">
                          {percentage}%
                        </span>
                      )}
                    </div>
